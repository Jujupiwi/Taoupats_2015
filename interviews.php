    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div id="divMenuRight" class="pull-right">
                <div class="navbar">
                    <button type="button" class="btn btn-navbar-highlight btn-inverse" data-toggle="collapse"
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav nav-pills ddmenu">
                            ...
                            <li class="visible-desktop"><a href="sondages.php">Sondages</a></li>
                            <li class="hidden-desktop"><a href="sondages-mobile.php">Sondages</a></li>
                            <li class="dropdown">
...
<div class="span12" id="divMain">
    ...
    <div id="accordion2" class="accordion">
        ...
        <div class="accordion-group">
            ...
            <div class="accordion-body collapse" id="collapseOne" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_alex.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            <div class="accordion-heading">
                <a href="#collapse23" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
                    Baptiste Vaillant
                </a>
            </div>
            <div class="accordion-body collapse" id="collapse23" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_baptiste.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            ...
            <div class="accordion-body collapse" id="collapseTwo" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_claude.php'; ?>
                    <?php include 'interviews/inter_fixe.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            ...
            <div class="accordion-body collapse" id="collapseThree" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_dede.php'; ?>
                    <?php include 'interviews/inter_fixe.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            <div class="accordion-heading">
                <a href="#collapse24" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
                    Edouard Clos
                </a>
            </div>
            <div class="accordion-body collapse" id="collapse24" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_edouard.php'; ?>>
                </div>
            </div>
        </div>
        <div class="accordion-group">
        ...
        <div class="accordion-group">
            ...
            <div class="accordion-body collapse" id="collapseFive" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_florent.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            ...
            <div class="accordion-body collapse" id="collapseSix" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_florian.php'; ?>
                    <?php include 'interviews/inter_fixe.php'; ?>
                </div>
            </div>
        </div>
        ...
        <div class="accordion-group">
            ...
            <div class="accordion-body collapse" id="collapseEight" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_gerald.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            ...
            <div class="accordion-body collapse" id="collapseNine" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_guigui.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            ...
            <div class="accordion-body collapse" id="collapseTen" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_jl.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
        ...
        <div class="accordion-group">
            <div class="accordion-heading">
                <a href="#collapseTwelve" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
                    Jordan Cointe
                </a>
            </div>
        ...
        <div class="accordion-group">
            <div class="accordion-heading">
                <a href="#collapse13" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
                    Julien Bonnefous
                </a>
            </div>
            <div class="accordion-body collapse" id="collapse13" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_julien.php'; ?>
                    <?php include 'interviews/inter_fixe.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            <div class="accordion-heading">
                <a href="#collapse14" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
                    Laurent Massot
                </a>
            </div>
            <div class="accordion-body collapse" id="collapse14" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_lolo.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            <div class="accordion-heading">
                <a href="#collapse15" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
                    Maxime Dardenne
                </a>
            </div>
            <div class="accordion-body collapse" id="collapse15" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_maxou.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            <div class="accordion-heading">
                <a href="#collapse16" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
                    Maxime Para
                </a>
            </div>
            <div class="accordion-body collapse" id="collapse16" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_maxP.php'; ?>
                    <?php include 'interviews/inter_fixe.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            <div class="accordion-heading">
                <a href="#collapse17" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
                    Maxime Sarlaboux
                </a>
            </div>
        ...
        <div class="accordion-group">
            ...
            <div class="accordion-body collapse" id="collapse18" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_olivier.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            <div class="accordion-heading">
                <a href="#collapse19" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
                    Paul Dardenne
                </a>
            </div>
            <div class="accordion-body collapse" id="collapse19" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_paul.php'; ?>
                    <?php include 'interviews/inter_fixe.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            <div class="accordion-heading">
                <a href="#collapse20" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
                    Tito Perez
                </a>
            </div>
            <div class="accordion-body collapse" id="collapse20" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_tito.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            <div class="accordion-heading">
                <a href="#collapse21" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
                    Tony Thebault
                </a>
            </div>
            <div class="accordion-body collapse" id="collapse21" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_tony.php'; ?>
                </div>
            </div>
        </div>
        <div class="accordion-group">
            <div class="accordion-heading">
                <a href="#collapse22" data-parent="#accordion2" data-toggle="collapse" class="accordion-toggle">
                    Fabrice Berdeil
                </a>
            </div>
            <div class="accordion-body collapse" id="collapse22" style="height: 0px;">
                <div class="accordion-inner">
                    <?php include 'interviews/inter_zizou.php'; ?>
                    <?php include 'interviews/inter_fixe.php'; ?>
                </div>
            </div>
        </div>
        ...
        <div class="row-fluid">
            <div class="span3" id="footerArea1">
                ...
                <p>
                    ...
                    <a class="visible-desktop" href="sondages.php" title="Sondages">Les sondages</a>
                    <a class="hidden-desktop" href="sondages-mobile.php" title="Sondages">Les sondages</a>
            ...
            <div class="span6" id="footerArea2">
                ...
                <p>
                    11/08 : Le tirage au sort des poules a été effectué par nos amis du district. Des derbys et très peu de déplacements.<br/>
                </p>
                <p>
                ...
                <p>
                    11/08 : Les chiffres de la saison 2013-2014 : 4ème place, 25 matchs joués, 11 victoires, 3 nuls, 11 défaites, 49 buts marqués, 44 encaissés ...<br/>
                </p>
...
<script type="text/javascript">function startCamera() {
    $('#camera_wrap').camera({ fx: 'scrollLeft', time: 4000, loader: 'none', playPause: false, navigation: true, height: '40%', pagination: true });
}
$(function () {
    startCamera()
});</script>
