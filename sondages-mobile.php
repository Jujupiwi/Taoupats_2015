                    ...
                    <div class="navbar">
                        ...
                        <div class="nav-collapse collapse">
                            <ul class="nav nav-pills ddmenu">
                                ...
                                <li class="visible-desktop"><a href="#">Sondages</a></li>
                                <li class="hidden-desktop"><a href="#">Sondages</a></li>
                                <li class="dropdown">
                    ...
                    <br>
                        ...
                        <div style="padding-bottom: 10px;">
                            ...
                            <form role="form" class="form" method="POST" action="contenu/login.php">
                                ...
                                <br><br>
                                <input type="submit" value="Valider" class="btn btn-inverse"/>
                            </form>
                        </div>
                        <div style="padding-bottom: 10px;">
                            <p>
                            ...
                            <form role="form" class="form" method="post" name="formNouveau" action="contenu/nouveau.php">
                                ...
                                <br><br>
                                <input id="validation" value="Valider" class="btn btn-inverse"/>
                            </form>
                        </div>
