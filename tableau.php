        ...
        <fieldset>
            <form class="form-horizontal well">
                ...
                <table class="table table-striped table-condensed table-hover">
                    ...
                    <tbody>
                    <?php
                    $test = "select equipe from classement where nom_tournoi = '$name' and login = '$login' order by points desc, diff desc, bp desc, bc, victoire desc, defaite;";
