    ...
    <div class="divPanel notop page-content">
        ...
        <div class="row-fluid">
            <div class="span8" id="divMain">
                ...
                <form name="enq" method="post" action="email/" onsubmit="return validation();">
                    <fieldset>
                        ...
                        <div class="actions">
                            <input type="submit" value="Envoyer le message" name="submit" id="submitButton"
                                   class="btn btn-inverse pull-right" title="Cliquez ici pour envoyer le message!"/>
                        </div>
            ...
            <div class="span4 sidebar">
                ...
                <div class="sidebox">
                    <h3 class="sidebox-title">Informations</h3>
                    <p>
                    <address><strong>Club de Daux</strong><br/>
                        Adresse :<br/>
                        Route du stade 31700 Daux<br/>
                        <abbr title="Phone">Tel:</abbr> 06 12 52 70 04
                    </address>
                    <address><strong>Email</strong><br/>
                        <a href="mailto:#"> josephbenedet@yahoo.fr </a></address>
                    </p>

                    <!-- Start Side Categories -->
                    <h4 class="sidebox-title">Autres Catégories</h4>
                    <ul>
                        ...
                        <li><a class="visible-desktop" href="sondages.php">Les sondages</a><a class="hidden-desktop" href="sondages-mobile.php">Les sondages</a></li>
                        <li><a href="interviews.php">Les interviews</a></li>
                    </ul>
                    <!-- End Side Categories -->
    ...
    <div class="divPanel">
        ...
        <div class="row-fluid">
            <div class="span3" id="footerArea1">
                ...
                <p>Le site vous permettra de consulter :</p>
