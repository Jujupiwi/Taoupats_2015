                ...
                <div class="navbar">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav nav-pills ddmenu">
                            ...
                            <li class="visible-desktop"><a href="sondages.php">Sondages</a></li><li class="hidden-desktop"><a href="sondages-mobile.php">Sondages</a></li>
                            <li class="dropdown">
...
<div class="contentArea">
    ...
    <div class="divPanel notop page-content">
        ...
        <div class="row-fluid">
            ...
            <div class="span12 visible-desktop" id="divMain">
                <h3>Statistiques saison 2014-2015</h3>

                <!-- Reste buteur/passeur FA Toulousain,
                Match complet Lespinasse-->
                <table
                        class="table table-bordered table-striped table-condensed table-hover">
                    <thead>
                    <tr>
                        <th style="text-align: center;">Joueur</th>
                        <th style="text-align: center;">Nb Matchs</th>
                        <th style="text-align: center;"><img src="images/blanc.png"></th>
                        <th style="text-align: center;"><img src="images/jaune.png"></th>
                        <th style="text-align: center;"><img src="images/rouge.png"></th>
                        <th style="text-align: center;">Homme du match</th>
                        <th style="text-align: center;">Buts</th>
                        <th style="text-align: center;">Ratio Buts/Match</th>
                        <th style="text-align: center;">Passes Décisives</th>
                        <th style="text-align: center;">Ratio Passes/Match</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td style="text-align: center">Alexis</td>
                        <td style="text-align: center"><?php $nb=0; echo $nb;?></td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center"><?php $nb=13; echo $nb;?></td>
                        <td style="text-align: center">0</td>
                        <td style="text-align: center">0</td>
                        <td style="text-align: center">0</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center"><?php $nb=11; echo $nb;?></td>
                        <td style="text-align: center">1</td>
                        <td style="text-align: center">0</td>
                        <td style="text-align: center">0</td>
                        <td style="text-align: center">1</td>
                        <td style="text-align: center"><?php $but=2; echo $but;?></td>
                        <td style="text-align: center"><?php if($nb!=0){echo substr($but/$nb, 0, 3);} else {echo 0;}?></td>
                        <td style="text-align: center"><?php $passe=6; echo $passe;?></td>
                        <td style="text-align: center"><?php if($nb!=0){echo substr($passe/$nb, 0, 3);} else {echo 0;}?></td>
                    </tr>
                    <tr>
                        <td style="text-align: center">Florent</td>
                        <td style="text-align: center"><?php $nb=1; echo $nb;?></td>
                        <td style="text-align: center">0</td>
                        <td style="text-align: center">0</td>
                        <td style="text-align: center">0</td>
                        <td style="text-align: center">0</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center"><?php $nb=12; echo $nb;?></td>
                        <td style="text-align: center">0</td>
                        <td style="text-align: center">0</td>
                        <td style="text-align: center">0</td>
                        <td style="text-align: center">1</td>
                        <td style="text-align: center"><?php $but=1; echo $but;?></td>
                        <td style="text-align: center"><?php if($nb!=0){echo substr($but/$nb, 0, 3);} else {echo 0;}?></td>
                        <td style="text-align: center"><?php $passe=2; echo $passe;?></td>
                        <td style="text-align: center"><?php if($nb!=0){echo substr($passe/$nb, 0, 3);} else {echo 0;}?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="text-align: center">Micka</td>
                        <td style="text-align: center"><?php $nb=11; echo $nb;?></td>
                        <td style="text-align: center">0</td>
                        <td style="text-align: center">0</td>
                        <td style="text-align: center">0</td>
                        <td style="text-align: center">1</td>
                        <td style="text-align: center"><?php $but=8; echo $but;?></td>
                        <td style="text-align: center"><?php if($nb!=0){echo substr($but/$nb, 0, 3);} else {echo 0;}?></td>
                        <td style="text-align: center"><?php $passe=3; echo $passe;?></td>
                        <td style="text-align: center"><?php if($nb!=0){echo substr($passe/$nb, 0, 3);} else {echo 0;}?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center"><?php $nb=10; echo $nb;?></td>
                        <td style="text-align: center">0</td>
                        <td style="text-align: center">1</td>
                        <td style="text-align: center">0</td>
                        <td style="text-align: center">1</td>
                        <td style="text-align: center"><?php $but=5; echo $but;?></td>
                        <td style="text-align: center"><?php if($nb!=0){echo substr($but/$nb, 0, 3);} else {echo 0;}?></td>
                        <td style="text-align: center"><?php $passe=1; echo $passe;?></td>
                        <td style="text-align: center"><?php if($nb!=0){echo substr($passe/$nb, 0, 3);} else {echo 0;}?></td>
                    </tr>
            ...
            <div class="span12 hidden-desktop" id="divMain">
                <h3>Statistiques saison 2014-2015</h3>
        ...
        <div class="row-fluid">
            <div class="span3" id="footerArea1">
                ...
                <p>
                    ...
                    <a href="#" title="Statistiques">Les statistiques</a><br/>
